...
function About() {
  return (
    <div className="about">
      ...
      <InfoBox2
      image = "https://res.cloudinary.com/dcuc1uetk/image/upload/v1755525192/volun11_nidyme.jpg"
        heading="Who We Are"
      ...
      />
      <InfoBox1
        image="https://res.cloudinary.com/dcuc1uetk/image/upload/v1755366034/DSC_4187_t470av.jpg"
      ...
      <InfoBox2
        image="https://res.cloudinary.com/dcuc1uetk/image/upload/v1755366056/DSC_1362_n6ftkq.jpg"
      ...
      <InfoBox1
        image="https://res.cloudinary.com/dcuc1uetk/image/upload/v1755366034/IMG_6129_cpmsyq.jpg"
